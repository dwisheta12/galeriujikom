...
$.getJSON(window.location.origin +'/profilsaya', function(res){
    console.log(res)
    $('#nama').html(res.data.username)
    $('#image').prop('src', '/assets/'+res.data.picture)
})
                ...
                <div class="flex flex-col px-2">
                    ...
                    <div class="flex flex-wrap items-center justify-between px-2 mt-2">
                        ...
                        <div>
                            ...
                            <span class="bi ${x.idUserLike === x.useractive ? 'bi-heart-fill text-red-500': 'bi-heart'} bi-heart" onclick="likes(this, ${x.id})"></span>
